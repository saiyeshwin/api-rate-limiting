...
import { KeyRound, Mail, AlertCircle, Activity } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8 bg-md-surface-container p-8 rounded-md-lg shadow-sm border border-md-outline/5 relative z-10">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            {/* Material Design 3 Filled Text Field (Rounded top, square bottom, bottom border) */}
            <div>
        ...
        <div className="text-center mt-4">
          <p className="text-xs text-md-on-surface-variant font-medium">
            ...
            <Link to="/signup" className="font-bold text-md-primary hover:underline">
              Sign up
            </Link>
          </p>
        </div>
